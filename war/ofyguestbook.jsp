...
<html>
 ...
 %>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="\ofyguestbook.jsp">Home</a>
          <a class="blog-nav-item" href="\post.jsp">Post</a>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Qian He</h1>
        <p class="lead blog-description">Welcome! This blog is open for anyone's thoughts as well.</p>
      </div>
   ...
   <%  
     if (greetings.isEmpty()) {
        ...
        <p>Currently there are no blog posts.</p>
	 ...
	 %>
            ...
            <p class="blog-post-meta">January 1, 2014 by <a href="#"><b>${fn:escapeXml(greeting_user.nickname)}</b></a></p>
      ...
      <% } 
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>About</h4>
            <p>I am a third-year computer engineering student at UT. Thanks for visiting my blog!</p>
          </div>
